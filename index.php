    ...
    <div class="header">
      <div class="veil">
        ...
        <div class="menu">
            ...
            <a href="javascript: void(0)" class="mobile-menu-button effect">
                <span class="bar"></span>
            </a>
        </div>
    ...
    <div class="footer">
        <div class="up">
            ...
            <div class="partners">
                ...
                <p>
                    <a href="http://workforland.azurewebsites.net/wd/mid/index.php" target="_blank">北科
                    I美食</a>
                </p>
            </div>
            <div class="about">
            ...
            <div class="contact">
                <h2>聯絡我們</h2>
                <p>
                    <a href="#">hahahaha@gmail.com</a>
                </p>
                <p>
                    <a href="#">OAO@gmail.com</a>
                </p>
            </div>
        </div>

        <div class="copyright">
            Copyright &copy; 2016. Designed by <a href="#">L.Guo</a>, <a href="#">OAO</a>
        </div>
    </div>
